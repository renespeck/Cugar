...
/**
 * <p>GraphReader instance that reads in graph file formatted using the
 ...
 * <a href="http://graphml.graphdrawing.org/">GraphML home page</a>.</p>
 * <p>The GraphMLReaderMod class is a very simple modification of 
 * prefuse GraphMLReader class. 
 * The modified class keeps the column for node labels in the edges table and 
 * this table is used to transform the file with EdgeListGraphReader class to a delimiter separated text file 
 * to use for the algorithms.
 *  </p>
 * 
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author rspeck (modified)
 * 
 */
public class GraphMLReaderMod extends AbstractGraphReader  implements GraphReader {
    ...
    public static class GraphMLHandler extends DefaultHandler implements Tokens
    {
                                 ...
                                 String qName, Attributes atts)
        {
            ...
            else if ( qName.equals(NODE) )
            {
                ...
                if(m_nodes.getColumn(NODE_NAME) == null)
                	m_nodes.addColumn(NODE_NAME,String.class,null);     
                m_nodes.set(m_row, NODE_NAME, id);
...
//                m_edges.setBoolean(m_row, DIRECTED, d);
        ...
        protected void addToSchema() {
            ...
            try {               
            	if(m_nsch.getColumnIndex(NODE_NAME) == -1)
                	m_nsch.addColumn(NODE_NAME,String.class,null);    	
